...
<!-- Note the position: relative style -->
<span style="position: relative">
  <FilledButton id="usageAnchor">Set with idref</FilledButton>
  <Menu id="usageMenu" anchor="usageAnchor">
    <MenuItem>
      <div slot="headline">Apple</div>
    </MenuItem>
    <MenuItem>
...
<span style="position: relative">
  <FilledButton id="usageAnchor2">Set with element ref</FilledButton>
  <Menu id="usageMenu2">
    <MenuItem>
      <div slot="headline">Apple</div>
    </MenuItem>
...
<!-- Note the position: relative style -->
<span style="position: relative">
  <FilledButton id="usageSubmenuAnchor">
    Menu with Submenus
  </FilledButton>
  <!-- Note the has-overflow attribute -->
  <Menu hasOverflow id="usageSubmenu" anchor="usageSubmenuAnchor">
    <SubMenu>
      <MenuItem slot="item">
      <div slot="headline">Fruits with A</div>
        <!-- Arrow icons are helpful affordances -->
...
<!-- Note the lack of position: relative parent. -->
<div style="margin: 16px;">
  <FilledButton id="usagePopoverAnchor">Open popover menu</FilledButton>
</div>

<!-- popover menus do not require a common ancestor with the anchor. -->
<Menu positioning="popover" id="usagePopover" anchor="usagePopoverAnchor">
  <MenuItem>
    <div slot="headline">Apple</div>
  </MenuItem>
  <MenuItem>
...
<!-- Note the lack of position: relative parent. -->
<div style="margin: 16px;">
  <FilledButton id="usageFixedAnchor">Open fixed menu</FilledButton>
</div>

<!-- Fixed menus do not require a common ancestor with the anchor. -->
<Menu positioning="fixed" id="usageFixed" anchor="usageFixedAnchor">
  <MenuItem>
    <div slot="headline">Apple</div>
  </MenuItem>
  <MenuItem>
...
<!-- Note the lack of position: relative parent. -->
<div style="margin: 16px;">
  <FilledButton id="usageDocumentAnchor">Open document menu</FilledButton>
</div>

<!-- document menus do not require a common ancestor with the anchor. -->
<Menu positioning="document" id="usageDocument" anchor="usageDocumentAnchor">
  <MenuItem>
    <div slot="headline">Apple</div>
  </MenuItem>
  <MenuItem>
...
<Menu
    ...
    ariaLabel="states"
    open>
  <MenuItem type="option" id="0">
    <div slot="headline">Alabama</div>
  </MenuItem>
  <Divider role="separator" tabindex="1"></Divider>
  <MenuItem type="option" id="1" selected ariaSelected="true">
    <div slot="headline">Alabama</div>
  </MenuItem>
</Menu>
```
...
<span style="position: relative">
  <FilledButton id="themingAnchor">Themed menu</FilledButton>
  <Menu id="themingMenu" anchor="themingAnchor">
    <MenuItem>
      <div slot="headline">Apple</div>
    </MenuItem>
    <MenuItem>
