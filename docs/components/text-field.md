...
```html
<FilledTextField label="label" value="value">
</FilledTextField>

<OutlinedTextField label="label" value="value">
</OutlinedTextField>
```
...
```html
<FilledTextField label="username" type="email">
</FilledTextField>
...
```html
<OutlinedTextField label="favorite food">
</OutlinedTextField>

<OutlinedTextField placeholder="email@domain.com">
</OutlinedTextField>

<div>First name</div>
<OutlinedTextField ariaLabel="first name">
</OutlinedTextField>
```
...
```html
<OutlinedTextField placeholder="search for messages">
  <Icon slot="leadingIcon">search</Icon>
</OutlinedTextField>

<OutlinedTextField label="password" type="password">
  <IconButton toggle slot="trailingIcon">
...
<OutlinedTextField
  ...
  <Icon slot="trailingIcon">error</Icon>
</OutlinedTextField>
```
...
```html
<OutlinedTextField label="title" value="short" maxlength="10">
</OutlinedTextField>
```
...
```html
<div>Username</div>
<FilledTextField ariaLabel="username"></FilledTextField>

<FilledTextField label="first" ariaLabel="first name"></FilledTextField>
```
...
```html
<FilledTextField label="filled" value="value"></FilledTextField>
```
...
```html
<OutlinedTextField label="outlined" value="value"></OutlinedTextField>
```
...
<FilledTextField label="filled" value="value">
</FilledTextField>
```
