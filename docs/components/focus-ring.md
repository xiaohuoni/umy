...
```html
    <button style="position: relative">
      <FocusRing style="MdFocusRingShape: 8px"></FocusRing>
    </button>
    ```
...
```html
    <div style="position: relative">
      <FocusRing for="control" style="MdFocusRingShape: 8px"></FocusRing>
      <input id="control">
    </div>
    ```
...
```html
    <div style="position: relative">
      <FocusRing id="ring" style="MdFocusRingShape: 8px"></FocusRing>
      <button id="ring-control"></button>
    </div>
    <script>
      const focusRing = document.querySelector('#ring');
...
```html
<button style="position: relative">
  <FocusRing inward style="MdFocusRingShape: 8px"></FocusRing>
</button>
```
