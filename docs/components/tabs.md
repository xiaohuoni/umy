...
```html
<Tabs>
  <PrimaryTab>Video</PrimaryTab>
  <PrimaryTab>Photos</PrimaryTab>
  <PrimaryTab>Audio</PrimaryTab>
</Tabs>

<Tabs>
  <SecondaryTab>Birds</SecondaryTab>
  <SecondaryTab>Cats</SecondaryTab>
  <SecondaryTab>Dogs</SecondaryTab>
</Tabs>
```
...
<Tabs>
  <PrimaryTab>Video</PrimaryTab>
  <PrimaryTab active>Photos</PrimaryTab>
  <PrimaryTab>Audio</PrimaryTab>
</Tabs>
```
...
<Tabs ariaLabel="content to view">
  <PrimaryTab ariaLabel="photos">
    <Icon slot="icon">photo</Icon>
  </PrimaryTab>
  <PrimaryTab ariaLabel="videos">
    <Icon slot="icon">videocam</Icon>
  </PrimaryTab>
  <PrimaryTab ariaLabel="music">
...
```html
<Tabs ariaLabel="content to view">
  <PrimaryTab id="photosTab" ariaControls="photosPanel">
    Photos
  </PrimaryTab>
  <PrimaryTab id="videosTab" ariaControls="videosPanel">
    Videos
  </PrimaryTab>
  <PrimaryTab id="musicTab" ariaControls="musicPanel">
    Music
  </PrimaryTab>
</Tabs>
