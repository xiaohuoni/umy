...
<Dialog>
  ...
  <div slot="actions">
    <TextButton form="formId">Ok</TextButton>
  </div>
</Dialog>
```
...
<Dialog open>
  <form slot="content" id="form-id" method="dialog">...</form>
  <div slot="actions">
    <TextButton form="formId" value="cancel">Cancel</TextButton>
    <TextButton form="formId" value="ok">Ok</TextButton>
  </div>
</Dialog>
```
...
```html
<Dialog ariaLabel="error message">
  <div slot="content">An error occurred, details ...</div>
</Dialog>
```
...
<Dialog type="alert">
  ...
  <div slot="actions">
    <TextButton form="formId" value="cancel">Cancel</TextButton>
    <TextButton form="formId" value="delete">Delete</TextButton>
  </div>
</Dialog>
```
