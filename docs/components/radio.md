...
```html
<form>
  <Radio name="animals" value="cats"></Radio>
  <Radio name="animals" value="dogs"></Radio>
  <Radio name="animals" value="birds" checked></Radio>
</form>
```
...
```html
<Radio id="catsRadio" name="animals" value="cats"></Radio>
<label for="cats-radio">Cats</label>

<Radio id="dogsRadio" name="animals" value="dogs"></Radio>
<label for="dogs-radio">Dogs</label>
```
...
<div role="radiogroup" aria-labelledby="group-title">
  <h3 id="group-title">Starting position</h3>
  <div>
    <Radio id="firstRadio" name="group" value="1"
        ariaLabel="first"></Radio>
    <label for="first-radio">1st</label>
  </div>
  <div>
    <Radio id="secondRadio" name="group" value="2"
        ariaLabel="second"></Radio>
    <label for="second-radio">2nd</label>
  </div>
</div>
```
...
<Radio name="group" checked></Radio>
<Radio name="group"></Radio>
```
