...
<LinearProgress value="0.5"></LinearProgress>
```
...
<LinearProgress fourColor indeterminate></LinearProgress>
```
...
```html
<CircularProgress value="0.5" ariaLabel="page refresh progress"></CircularProgress>

<LinearProgress value="0.5" ariaLabel="download progress"></LinearProgress>
```
...
```html
<CircularProgress indeterminate></CircularProgress>
<CircularProgress value="0.6"></CircularProgress>
```
...
```html
<LinearProgress indeterminate></LinearProgress>
<LinearProgress value="0.6"></LinearProgress>
```
...
```html
<LinearProgress value="0.5" buffer="0.8"></LinearProgress>
```
